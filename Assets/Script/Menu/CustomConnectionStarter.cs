<<<<<<<< HEAD:Assets/Script/Multi/CustomConnectionStarter.cs
using PurrLobby;
...
public class CustomConnectionStarter : MonoBehaviour
{
    ...
    private void UpdatePlayerNumbers()
    {
        ...
        {
            PurrLogger.LogWarning("Can't setup the number of player to wait for");
        }
    }
    ...
    private async System.Threading.Tasks.Task ConfigureRelayData()
    {
        ...
        if(utpTransport != null) {
            ...
            if(lobby.IsOwner) {
                ...
                // Client data: Required for host's client in P2P mode
                ...
                // Host needs client relay data for P2P mode
...
>>>>>>>> develop:Assets/Script/Menu/CustomConnectionStarter.cs
