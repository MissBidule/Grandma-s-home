 ...
 */
public class TChildInputController : MonoBehaviour
{
    ...
    public TChildClientController m_childClientController;
    ...
    void Awake()
    {
        m_childClientController = GetComponent<TChildClientController>();
