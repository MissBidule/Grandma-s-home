...
public class SoloCameraController : MonoBehaviour
{
    ...
    private SoloPlayerController m_ghostController;
    ...
    */
    private void Awake()
    {
        m_ghostController = GetComponentInParent<SoloPlayerController>();
    ...
    */
    private void LateUpdate()
    {
        ...
        bool blockLookInput = m_ghostController == null;
        if (blockLookInput)
        {
        ...
        Vector2 lookInput = m_ghostController.m_lookInputVector;
