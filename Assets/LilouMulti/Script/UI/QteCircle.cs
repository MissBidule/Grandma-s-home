...
/**
@brief       Script du QTE cercle � plusieurs phases
@details     La classe \c QteCircle g�re un QTE circulaire en plusieurs niveaux de difficult�
...
public class QteCircle : NetworkBehaviour
{
    ...
    @param      _onFinished: callback true si toutes les phases sont r�ussies
    @return     void
    */
    ...
    @param      _success: true si toutes les phases sont r�ussie
    @return     void
    */
    ...
    */
    ...
    /**
    @brief      Replace l'aiguille au point de d�part 
    @return     void
    */
    ...
    /**
    @brief      Place la zone de succ�s � un angle al�atoire
    @return     void
    */
    ...
    /**
    @brief      Active seulement la zone correspondant � la phase courante
    @return     void
    */
    ...
    /**
    @brief      R�cup�re le marker de zone selon la phase courante
    ...
    */
    ...
    /**
    @brief      V�rifie si l'aiguille est dans la zone de succ�s de la phase courante
    @return     true si r�ussite
    */
    ...
    /**
    @brief      R�cup�re la tol�rance de la phase courante
    @return     tol�rance en degr�s
    */
