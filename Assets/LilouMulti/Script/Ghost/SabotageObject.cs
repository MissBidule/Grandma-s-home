...
@details     La classe \c SabotageObject g�re le sabotage (QTE, meshes, highlight, score) et expose une interaction
             contr�l�e par le joueur via \c IPlayerInteractable.
*/
